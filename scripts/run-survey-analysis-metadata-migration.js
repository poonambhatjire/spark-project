/**
 * Clarify optional survey fields for analysis.
 * Run: node scripts/run-survey-analysis-metadata-migration.js
 */
...
async function main() {
  ...
  const sqlPath = path.join(__dirname, "..", "database", "add-survey-analysis-metadata.sql")
  ...
  try {
    ...
    console.log("OK: survey analysis metadata migration applied.")
  } catch (err) {
