/**
 * Enable RLS on sensitive/public tables without planned downtime.
 * Run: node scripts/run-rls-security-hardening-migration.js
 */
...
async function main() {
  ...
  const sqlPath = path.join(__dirname, "..", "database", "enable-rls-security-hardening.sql")
