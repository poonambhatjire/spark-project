-- =============================================
-- REVERT: Work Interruptions/ Miscellaneous -> Work Interruptions/ Miscellaneous/ Non-ASP time
-- Keep full name at bottom of dropdown
-- =============================================

ALTER TABLE time_entries DROP CONSTRAINT IF EXISTS time_entries_task_check;

UPDATE time_entries
SET task = 'Work Interruptions/ Miscellaneous/ Non-ASP time'
WHERE task = 'Work Interruptions/ Miscellaneous';

UPDATE activities
SET name = 'Work Interruptions/ Miscellaneous/ Non-ASP time'
WHERE name = 'Work Interruptions/ Miscellaneous';
